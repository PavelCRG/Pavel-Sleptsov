...
Сайт-портал по двум курсам: **3 курс** и **4 курс** («Программные средства создания интернет-приложений»).
...
index.html              выбор курса (3 или 4)
    ├── course-3.html   3 курс: лабораторные, лекции, контроль, практика
    │       ↓
    │   pages/…         разделы 3 курса
    └── course-4.html   4 курс: лабораторные, лекции, контроль
            ↓
        pages/course-4/ разделы 4 курса
```
...
├── course-3.html           главная 3 курса
├── course-4.html           главная 4 курса
├── portal.html             редирект → course-3.html
├── README.md               эта документация
│
├── assets/images/          логотипы и иконки портала
├── css/                    стили (точка входа — main.css)
├── js/                     меню и просмотрщик материалов
├── pages/                  страницы 3 курса (+ overviews/)
│   └── course-4/           страницы 4 курса (+ overviews/)
├── materials/              файлы 3 курса (lab/, lection/, …)
│   └── course-4/           файлы 4 курса (lab/, lection/, …)
...
├── components/
│   ├── portal-home.css           главная course-3.html
